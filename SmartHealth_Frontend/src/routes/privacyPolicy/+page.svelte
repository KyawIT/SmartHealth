...
<div class="bg-gray-100 ml-6 bg-white" id="container">
    <div class="grid grid-cols-2 gap-x-5 mx-10">
        <div>
            <img 
            src="\frontend\privacyPolicy.png"
            class = "max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-auto"
            alt="ERROR">
        </div>
        <div class=" m-auto">
            <h1 class="my-5 text-6xl font-black text-blue-600 dark:text-blue-600">Privacy Policy</h1>
        </div>
    </div>
    ...
    <ul class="list-disc list-inside mb-4">
        <li>If you have previously agreed to us using your personal information for direct marketing purposes, you
            may
            change your mind at any time by writing to or emailing us at smarthealthorganisation@gmail</li>
        ...
        <li>You may request details of personal information which we hold about you. If you would like a copy of the
            information held on you, please write to SmartHealth, Austria, 4020 Linz or email
            smarthealthorganisation@gmail</li>
