<div id="container" class="mt-5">
  ...
  <form class="max-w-sm mx-auto">
    ...
    <div class="grid grid-cols-1 gap-y-5 mb-5">
      ...
      <button
        type="button"
        class="inline-flex items-center justify-center w-full text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30"
      >
        <svg
