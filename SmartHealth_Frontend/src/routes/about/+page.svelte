...
<div class="relative">
  ...
  >
    ...
    <div class="mt-10 drop-shadow-2xl h-auto">
    ...
    <a class="" href="#thirdSlide"
      ><img src="./svgs/down_arrow.svg" width="100" height="100" /></a
    >
  </div>
  <div
    class="sticky top-0 h-screen flex flex-col items-center justify-center bg-rose-600 text-white"
    id="thirdSlide"
  >
    <h5
      class="mb-10 text-6xl font-black text-white dark:text-white text-center"
    ...
    <p class="text-2xl font-medium text-white text-center">
      ...
      <span class="underline hover:no-underline">Full-Stack-Dev</span><br
      /><span class="font-extrabold hover:italic">Nikola</span> specializes in
